...
<head>
  ...
  <!-- Favicons -->
  <link href="menu1/assets/img/favicon.png" rel="icon">
  <link href="menu1/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <section id="hero" class="hero d-flex align-items-center section-bg">
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start" style="font-family: poppins">
          <h2 data-aos="fade-up">Welcome to <br>Canteen Management System</h2>
          <p data-aos="fade-up" data-aos-delay="100">Sed autem laudantium dolores. Voluptatem itaque ea consequatur eveniet. Eum quas beatae cumque eum quaerat.</p>
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
          </div>
        </div>
        <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
          <img src="menu1/assets/img/hero-img.png" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="300">
        </div>
      </div>
    </div>
        ...
        <div class="tab-content" data-aos="fade-up" data-aos-delay="300">
          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                <a href="menu1/assets/img/menu/menu-item-4.png" class="glightbox"><img src="menu1/assets/img/menu/menu-item-4.png" class="menu-img img-fluid" alt=""></a>
                <h4>Eos Luibusdam</h4>
                <p class="ingredients">
          ...
          <div class="tab-pane fade" id="menu-breakfast">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                <a href="menu1/assets/img/menu/menu-item-1.png" class="glightbox"><img src="menu1/assets/img/menu/menu-item-1.png" class="menu-img img-fluid" alt=""></a>
                <h4>Magnam Tiste</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="menu1/assets/img/menu/menu-item-2.png" class="glightbox"><img src="menu1/assets/img/menu/menu-item-2.png" class="menu-img img-fluid" alt=""></a>
                <h4>Aut Luia</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="menu1/assets/img/menu/menu-item-3.png" class="glightbox"><img src="menu1/assets/img/menu/menu-item-3.png" class="menu-img img-fluid" alt=""></a>
                <h4>Est Eligendi</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
